import { Component, effect, EventEmitter, Input, Output, signal, SimpleChanges, TemplateRef, ViewChild } from '@angular/core';
import { NOT_FOUND_MSG } from '../../constants/constants';
import { MetaData } from '../../interfaces/http-common-response';
...
@Component({
  selector: 'app-table',
  standalone: true,
  imports: [CommonModule, PaginatorComponent, ButtonComponent],
